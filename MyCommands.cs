...
namespace TestFormulaTrace
{
    public static class MyCommands
    {
        ...
        [ExcelCommand(MenuName = "TestFormulaTrace", MenuText = "Dump Data", ShortCut = "^D")]
        ...
        [ExcelCommand(MenuName = "TestFormulaTrace", MenuText = "ShowActiveFormula", ShortCut = /*Excel shortcut Alt+s*/ "%s")]
        public static void ShowActiveFormula()
        {
            Application app = (Application)ExcelDnaUtil.Application;
            var activeCell = app.ActiveCell;
            string formula = activeCell.Formula.ToString();
            System.Windows.Forms.MessageBox.Show($"The active cell formula is: {formula}", "Active Cell Formula");
        }
    }
